...
class WC_Stripe {
	...
	public function __construct() {
		define( 'WC_STRIPE_VERSION', '2.0.1' );
	...
	public function init() {
		...
		if ( class_exists( 'WC_Subscriptions_Order' ) ) {
			include_once( 'includes/class-wc-gateway-stripe-subscriptions.php' );
		}
	...
	public function delete_card_handler() {
		...
		delete_user_meta( get_current_user_id(), '_stripe_customer_id', $credit_cards[ absint( $_POST['stripe_delete_card'] ) ] );
	...
	public function saved_cards() {
		...
		woocommerce_get_template( 'saved-cards.php', array( 'credit_cards' => $credit_cards ), 'woocommerce-gateway-stripe/', WC_STRIPE_TEMPLATE_PATH );
	}
